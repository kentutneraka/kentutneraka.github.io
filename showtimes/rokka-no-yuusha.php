    ...
    <body onLoad="muatDaftarData();">
        ...
        <div class="col-md-8 col-md-offset-2" ng-controller="listContactCtrl">
            ...
            <div id="list-data" class="well">
                <iframe src="https://docs.google.com/forms/d/1a2rrosYve71ZPdJFBjEdGb4AI_3DyzRwd_Qxc45tRhQ/viewform?embedded=true" width="760" height="500" frameborder="0" marginheight="0" marginwidth="0">Memuat...</iframe>
            </div>
...
<table width="90%" border="0.5">
 <tr>
  ...
  <tr>
    ...
    <td width="28%" bgcolor="#FFFFFF">Rokka no Yuusha </td>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF">Pahlawan Enam Bunga  </td>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><span class="style5">Minggu - 02.15 WIB </span></td>
...
&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://wagnaria-kn.zz.mu/">Kembali</a> | <a href="http://www.kentutneraka.org/search/label/Rokka%20no%20Yuusha">Rilisan di sini</a>
                    </div>
        </div>
