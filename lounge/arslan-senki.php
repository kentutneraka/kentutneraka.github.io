    ...
    <body onLoad="muatDaftarData();">
        ...
        <div class="col-md-8 col-md-offset-2" ng-controller="listContactCtrl">
            ...
            <div id="list-data" class="well">
                <iframe src="https://docs.google.com/forms/d/1jPXiVEkdB_RrtRO5951pmIlVQOaXNSM9s2O6ls6KUjA/viewform?embedded=true" width="760" height="500" frameborder="0" marginheight="0" marginwidth="0">Memuat...</iframe>
            </div>
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td width="" bgcolor="#FFFFFF"><span class="style10"><span class="style5">MBS</span></span></td>
	<td width="" bgcolor="#FFFFFF"><div align="right" class="style10"><strong>Encoder</strong></div></td>
    <td width="" bgcolor="#FFFFFF"><span class="style10">&nbsp;&nbsp;&nbsp;&nbsp;rakaosd</span></td>
  </tr>
   <tr>
    <td width="21%" bgcolor="#FFFFFF"><span class="style7">&nbsp;</span></td>
    <td width="28%" bgcolor="#FFFFFF"><span class="style10">&nbsp;</span></td>
...
&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://wagnaria-kn.zz.mu/">Kembali</a> | <a href="http://www.kentutneraka.org/search/label/Arslan%20Senki%20%28The%20Heroic%20Legend%20of%20Arslan%29">Rilisan di sini</a>
                    </div>
        </div>
