    ...
    <body onLoad="muatDaftarData();">
        ...
        <div class="col-md-8 col-md-offset-2" ng-controller="listContactCtrl">
            ...
            <div id="list-data" class="well">
                <iframe src="https://docs.google.com/forms/d/11CK5XDoYGA6IMycJeJI4JB4P6BOXiChbLcBYvA6A-v8/viewform?embedded=true" width="760" height="500" frameborder="0" marginheight="0" marginwidth="0">Memuat...</iframe>
            </div>
...
<table width="90%" border="0.5">
 <tr>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><span class="style5">Minggu - 01.15 WIB </span></td>
...
&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://wagnaria-kn.zz.mu/">Kembali</a> | <a href="http://www.kentutneraka.org/search/label/Working!!!">Rilisan di sini</a>
                    </div>
        </div>
...
<script type="text/javascript">
    ...
    var disqus_shortname = 'kentutneraka';
